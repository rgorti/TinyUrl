...
public class TinyUrlServiceImpl implements TinyUrlService{
    ...
    public TinyUrl create(String sourceUrl, String customUrl){
        ...
        if (customUrl != null) {
                if ((customUrl.length() < 5) || (customUrl.length() > 16))
                    throw new InvalidUrlException("The given custom URL is too short or exceeds limit. Min number of characters for custom url is 5 char and Max to 16");
                if (existsCustom(customUrl)) {
